...
| 2022-06-22 | Terra Proposal 4095, "Re-enable Staking/Delegation to Existing Active Validator Set Only," passes with 90.67% of 165,318,228 staked LUNC. 43 validators voted yes, 5 abstained, and none were rejected or vetoed. Validators who Abstained included ChainLayer, danku_zone w/ DAIC, Mrk.K, Easy 2 Stake, and TTLG Money. Validators who didn't vote included Orion.Money (14.13%), hashed (4.13%), DSRV (3.06%), Figment (2.76%), Certus One(2.45%), Terran One (2.45%), Terra Bites (1.95%), Aardvark (1.74%), StakeWith.Us (1.67%), Staked (1.55%), blockscape, BinanceStaking, MANTRA DAO, ISS, TerraIsMoreThanUST, 319B5FDFEF84, 0base.vc, Mosaic, RockX, Arrington XRP Capital, coinbevy, TerraDactyl, Craig, Inotel, SeltonStake.com - sunsetting soon, KiKi Finance, Pixy, OneStar, TaiPanich, MissionControl, Galactic Punks Validator, Stake5 Labs, DACM (.09%), and appx 15 others with negligible votes.
